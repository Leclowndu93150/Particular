...
- **Custom water-like fluids (config).** New `customFluidsSettings.waterLikeFluids` list — fluid IDs treated like vanilla water for splash, rain ripples, and waterfall spray. Example: `"tfc:river_water"`.
